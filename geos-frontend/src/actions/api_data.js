...
export const FETCH_CITY_SCHOOLS = "apiData/FETCH_CITY_SCHOOLS";
export const FETCH_STATE_CITIES = "apiData/FETCH_STATE_CITIES";
...
export const RECEIVE_STATE_CITIES = "apiData/RECEIVE_STATE_CITIES";
